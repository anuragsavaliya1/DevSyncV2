...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen bg-[#F6F8FB] lg:grid-cols-[1.1fr_0.9fr]">
      ...
      <section className="flex items-center justify-center p-5 sm:p-10"><div className="w-full max-w-md rounded-[24px] border border-[#E4ECEF] bg-white p-7 shadow-[0_20px_60px_rgba(25,55,75,0.09)] sm:p-10"><div className="mb-9 lg:hidden"><p className="font-display text-2xl font-extrabold tracking-[-0.06em] text-[#173247]">devsync</p><p className="mt-1 text-[9px] font-extrabold uppercase tracking-[0.14em] text-[#0E9384]">daily operating system</p></div><div className="mb-7"><p className="text-[10px] font-extrabold uppercase tracking-[0.16em] text-[#0E9384]">Welcome back</p><h2 className="mt-3 font-display text-3xl font-extrabold tracking-[-0.055em] text-[#173247]">Sign in to your workspace.</h2><p className="mt-3 text-sm font-medium leading-6 text-[#758696]">Use your approved Google account to access DevSync.</p></div><a href="/login/native" className="group flex w-full items-center justify-center gap-3 rounded-xl bg-[#0E9384] px-5 py-3.5 text-sm font-extrabold text-white transition duration-200 hover:bg-[#087A6D] active:scale-[0.98]"><Chrome className="h-4 w-4" />Continue with Google<ArrowRight className="h-4 w-4 opacity-0 transition group-hover:translate-x-0.5 group-hover:opacity-100" /></a><div className="mt-7 flex gap-3 rounded-xl border border-[#E3EDF0] bg-[#F8FBFB] p-3"><ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#0E9384]" /><p className="text-[11px] font-semibold leading-5 text-[#6E8190]">Google identity is verified server-side before DevSync creates a secure session or reads any team data.</p></div></div></section>
    </main>
  );
}
